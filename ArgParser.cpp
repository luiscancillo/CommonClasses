...
Option::Option(int id, string name, string value, bool isLong, bool isString) {
	identification = id;
	if (isLong) {	//It is a long format option
		sName.clear();
		lName = name;
 ...
 */
Option::Option(int id, const char * s, const char * l, const char * d, const char * u, const char * v) {
	identification = id;
	sName = string(s);
	lName = string(l);
 ...
 *@param v default value for the option
 */
Option::Option (int id, const char * s, const char * l, const char * d, const char * u, bool v) {
	identification = id;
	sName = string(s);
	lName = string(l);
	description = string(d);
 ...
 */
int ArgParser::addOption (const char * s, const char * l, const char * d, const char * u, const char * sv) {
 ...
 *@return the identification assigned to the option
 */
int ArgParser::addOption (const char * s, const char * l, const char * d, const char * u, bool bv) {
 ...
 */
int ArgParser::addOperator (const char * v) {
