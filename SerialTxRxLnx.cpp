...
/**
 * Construct a CBRrate object using the parameters passed
 *
 * @param r the communications baud rate
 * @param CBRr  the baud rate identifier as per termios
 */
...
/**sleepTime stops the process for the milliseconds stated
 * Here it is implemented a version for Linux
 */
